...
adb pull /system/bin/pppd ../../../vendor/$MANUFACTURER/$COMMON/proprietary/pppd
adb pull /system/bin/pppd_runner ../../../vendor/$MANUFACTURER/$COMMON/proprietary/pppd_runner
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__COMMON__/proprietary/pppd:system/bin/pppd \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/pppd_runner:system/bin/pppd_runner 
